  ...
  function loadHtml5Gallery(s) {
          ...
          return this.each(function() {
              function a(a) {
                  ...
                  1 <= d.targetTouches.length ?
                      (f = d.targetTouches[0].pageX, h = d.targetTouches[0].pageY) : j(a)
              }
              ...
              try {
                  w(this).bind("touchstart",
                      a), w(this).bind("touchmove", b), w(this).bind("touchend", d), w(this).bind("touchcancel", j)
              } catch (S) {}
          })
      };
      var m = jQuery;
                  ...
                  if (a) {
                      ...
                      do
                          if ((t = a.interactions[g]) && !("dragend" !== e && t.cancelled)) p = q.properties(b, a, t), t.results = [], m(d || t[h] || a.droppable).each(function(d, c) {
                              p.target = c;
                              l = v.handle ? c ? v.handle.call(c, b, p) : null : c ? v.dispatch.call(c, b, p) : null;
                              !1 === l ? ("drag" == h && (t.cancelled = !0, a.propagates -= 1), "drop" == e && (t[h][d] = null)) : "dropinit" == e && t.droppable.push(q.element(l) || c);
                              "dragstart" == e && (t.proxy = m(q.element(l) || t.drag)[0]);
                              t.results.push(l);
                              delete b.result;
                              if ("dropinit" !==
                                  e) return l
      ...
      B.fn.html5boxTransition = function(b, e, a, c, d) {
          ...
          var j = c.easing,
              ...
              h = c.direction,
              l = null;
          b && (b = b.split(","), l = b[Math.floor(Math.random() * b.length)], l = B.trim(l.toLowerCase()));
      ...
      var k = jQuery;
      k.fn.addHTML5VideoControls = function(b, e, a) {
          ...
          var x = k("<div class='html5boxVideoPlay'></div>");
          q || (n.after(x), x.css({
              position: "absolute",
              top: "50%",
              left: "50%",
          ...
          setInterval(function() {
              p && (u.show(), p = !1, clearTimeout(l), l = setTimeout(function() {
                  n.get(0).paused || u.fadeOut()
              }, 5E3))
          }, 250);
          k(".html5boxVideoControlsBg", u).css({
              display: "block",
              position: "absolute",
              width: "100%",
              height: "100%",
          ...
          var A = k(".html5boxTimeCurrent",
                  u),
              B = k(".html5boxTimeTotal", u),
              C = k(".html5boxSeeker", u),
              r = k(".html5boxSeekerPlay", u),
              G = k(".html5boxSeekerBuffer", u),
              K = k(".html5boxSeekerHandler", u);
          A.css({
              display: "block",
              position: "relative",
              "float": "left",
          ...
          if (!q && (n.get(0).requestFullscreen || n.get(0).webkitRequestFullScreen || n.get(0).mozRequestFullScreen || n.get(0).webkitEnterFullScreen || n.get(0).msRequestFullscreen)) {
              var E = function(a) {
                  ...
                  a ? (k(document).bind("mousemove", Q), u.css({
                      "z-index": 2147483647
                  })) : (k(document).unbind("mousemove", Q), u.css({
                      "z-index": ""
                  }))
              };
              ...
              k("head").append("<style type='text/css'>#" + a + "::-webkit-media-controls { display:none !important; }</style>");
              var N = k(".html5boxFullscreen", u);
              N.css({
                  display: "block",
                  position: "relative",
                  "float": "right",
          ...
          if (n.get(0).volume === a / 2 + 0.1) {
              n.get(0).volume = a;
              a = k(".html5boxVolume", u);
              var L = k(".html5boxVolumeButton", u),
                  F = k(".html5boxVolumeBar", u),
                  y = k(".html5boxVolumeBarBg", u),
                  M = k(".html5boxVolumeBarActive", u);
              a.css({
                  display: "block",
                  position: "relative",
                  "float": "right",
              ...
              L.css({
                  ...
                  var a = k(this).css("background-position") ? k(this).css("background-position").split(" ")[0] :
                      k(this).css("background-position-x");
                  k(this).css({
                      "background-position": a + " top"
                  })
              }).bind("click", function() {
      ...
      b.fn.html5gallery = function(k) {
          ...
          e.prototype = {
              ...
              init: function(a) {
                  ...
                  a.options.watermarkcode += "<div " + (a.options.fv ? "" : "class='html5gallery-watermark-" + a.id + "' ") + "style='" + (a.options.fv ? "" :
                  ...
                  0 >= a.elemArray.length || (a.createEvents(), a.loadCarousel(), a.savedElem = -1, a.curElem = -1, a.nextElem = -1, a.prevElem = -1, a.isPaused = !a.options.autoslide, a.isFullscreen = !1, a.isVideoPlaying = !1, a.showingPoster = !1, a.disableTouchSwipe = !1, a.createSocial(!1), c = a.getParams(), d = 0, c.html5galleryid && c.html5galleryid in a.elemArray && (d = c.html5galleryid), c.galleryshareid && c.galleryshareid in a.elemArray && (d = c.galleryshareid), a.slideRun(d), a.options.responsive && (a.resizeGallery(), b(window).resize(function() {
                      a.resizeGallery()
                  })))
              },
              ...
              createSocial: function(a) {
                  ...
                  if (this.options.showsocial) {
                      ...
                      a ? b(".html5gallery-fullscreen-box-" +
                          this.id, this.$fullscreen).append(d) : (b(".html5gallery-box-" + this.id, this.$gallery).append(d), "mouseover" == this.options.socialmode && b(".html5gallery-container-" + this.id).hover(function() {
              ...
              readTags: function() {
                  ...
                  (b("img.html5galleryimg", this.container).length ? b("img.html5galleryimg", this.container) : b("img", this.container)).each(function() {
                      for (var c = b(this).attr("src"), d = a.options.lazyloadtags.split(","),
                              e = 0; e < d.length; e++)
                      ...
                      a.elemArray.push([a.elemArray.length, c, d, t, p, k, q, e, f, A, h, l, m, s, n, v, g, w, x, u, B, z, D])
                  })
              },
                  ...
                  b.getJSON(g, function(b) {
                      if (b && b.items)
                          for (var g = 0; g < b.items.length; g++) {
                              ...
                              l = [g, "https://img.youtube.com/vi/" + l + "/0.jpg", "https://www.youtube.com/embed/" + l, null, null, null, null, b.items[g].snippet.title,
                                  b.items[g].snippet.description, 9, 640, 480, k, null, null, null, null
                              ];
              ...
              createEvents: function() {
                  ...
                  b(".html5gallery-box-" + this.id, this.$gallery).hover(function() {
                      ...
                      if (a.options.titleoverlay && a.options.titleautohide && (!a.options.hidetitlewhenvideoisplaying ||
                              !a.isVideoPlaying)) b(".html5gallery-title-" + a.id, a.$gallery).fadeIn(), clearTimeout(a.hideTitleTimeout), a.hideTitleTimeout = setTimeout(function() {
                  ...
                  b(".html5gallery-box-" + this.id).mousemove(function() {
                      if (a.options.titleoverlay && a.options.titleautohide &&
                          (!a.options.hidetitlewhenvideoisplaying || !a.isVideoPlaying)) b(".html5gallery-title-" + a.id, a.$gallery).show(), clearTimeout(a.hideTitleTimeout), a.hideTitleTimeout = setTimeout(function() {
                          b(".html5gallery-title-" + a.id, a.$gallery).fadeOut()
                      }, 3E3)
                  });
                  ...
                  ("vertical" == this.options.skin || "showcase" == this.options.skin) &&
                  b(".html5gallery-car-list-" + this.id, this.$gallery).bind("DOMMouseScroll mousewheel wheel", function(c) {
                      c.preventDefault();
                      ...
                      c = parseInt(b(".html5gallery-thumbs-" + a.id,
                          a.$gallery).css("marginTop")) + f;
                      0 < c && (c = 0);
                      c < e && (c = e);
              ...
              resizeStyleVertical: function() {
                  if (this.container.parent() && this.container.parent().width()) {
                      ...
                      "bottom" == this.options.carouselposition ? this.options.width = this.options.totalWidth - 2 * this.options.padding : (this.options.width = this.options.totalWidth - 2 * this.options.padding, 0 < this.options.carouselWidth + this.options.carouselmargin && (this.options.width -= this.options.carouselWidth +
                          this.options.carouselmargin));
                      this.options.responsivefullscreen && 0 < this.container.parent().height() ? (this.options.containerHeight = this.container.parent().height(), this.options.totalHeight = this.options.containerHeight, this.options.height = "bottom" == this.options.carouselposition ? this.options.totalHeight - (this.options.headerHeight + 2 * this.options.padding + this.options.carouselheight) : this.options.totalHeight - (this.options.headerHeight + 2 * this.options.padding)) : (this.options.height = Math.round(this.options.width *
                      ...
                      if (this.options.showcarousel)
                          if ("bottom" == this.options.carouselposition) {
                              ...
                              this.options.carouselSlider =
                                  Math.floor(this.options.carAreaLength / (this.options.thumbheight + this.options.thumbgap)) < this.elemArray.length;
                              ...
                              this.options.thumbshowtitle && b("head").append("<style type='text/css' data-creator='html5gallery'>.html5gallery-tn-title-" +
                                  this.id + " {width: " + a + "px;}</style>")
                              ...
                              20, this.options.width -= 20, this.options.boxWidth = this.options.width, this.options.slideshadow && (this.options.boxWidth += 8)), "left" == this.options.carouselposition ? (this.options.boxLeft = this.options.padding + this.options.carouselWidth + this.options.carouselmargin, this.options.carouselLeft = this.options.padding) : this.options.carouselLeft = this.options.padding + this.options.width + this.options.carouselmargin, this.options.carouselTop = this.options.padding;
                      ...
                      if (1 == a || this.showingPoster) {
                          ...
                          if (this.isFullscreen) {
                              var e = this.elemArray[this.curElem][17] ? Math.min(this.elemArray[this.curElem][17], this.fullscreenWidth) :
                      ...
                      } else if (5 == a || 6 == a || 7 == a || 8 == a || 9 == a || 10 == a || 11 == a) a = this.elemArray[this.curElem][10], c = this.elemArray[this.curElem][11], this.isFullscreen ? (e = this.elemArray[this.curElem][17] ? Math.min(this.elemArray[this.curElem][17], this.fullscreenWidth) :
                          ...
                          width: a + "px",
                          height: d + "px"
                      }), b("#html5gallery-elem-video-" + this.id).attr("width", a), b("#html5gallery-elem-video-" + this.id).attr("height", d), b(".html5gallery-elem-video-" + this.id).find("iframe").attr("width", a), b(".html5gallery-elem-video-" + this.id).find("iframe").attr("height", d), b("#html5gallery-elem-video-" + this.id).find("iframe").attr("width",
                          a), b("#html5gallery-elem-video-" + this.id).find("iframe").attr("height", d);
                      d = e = 0;
                      ...
                      this.options.showcarousel && (b(".html5gallery-car-" + this.id).css({
                          ...
                          (this.options.carouselSliderMin = 0, this.options.carouselSliderMax = this.options.thumbMaskHeight - 54, b(".html5gallery-car-slider-bar-" + this.id).css({
              ...
              createStyleVertical: function() {
                  this.options.thumbimagewidth = this.options.thumbshowtitle ? this.options.thumbheight -
                      2 * this.options.thumbimageborder - 4 : this.options.thumbwidth - 2 * this.options.thumbimageborder - 4;
                  ...
                  this.options.slideshadow && (this.options.boxWidth += 8);
                  this.options.showcarousel ? "bottom" == this.options.carouselposition ? (this.options.carouselWidth = this.options.width, this.options.carouselHeight = this.options.carouselheight, this.options.carouselLeft = this.options.padding, this.options.carouselTop = this.options.height +
                      ...
                      this.options.padding + this.options.width + this.options.carouselmargin, this.options.carouselTop = this.options.padding) : (this.options.carouselWidth = 0, this.options.carouselHeight = 0, this.options.carouselLeft = 0, this.options.carouselTop = 0, this.options.carouselmargin = 0);
                  "bottom" == this.options.carouselposition ? (this.options.totalWidth = this.options.width + 2 * this.options.padding, this.options.totalHeight = this.options.height + this.options.headerHeight + 2 * this.options.padding + this.options.carouselmargin + this.options.carouselHeight) :
                      (this.options.totalWidth = this.options.width + this.options.carouselWidth + this.options.carouselmargin + 2 * this.options.padding, this.options.totalHeight = this.options.height + this.options.headerHeight + 2 * this.options.padding);
                  ...
                  var d = d + (" .html5gallery-box-" + this.id + " {display:block; position:absolute; text-align:center; left:" + this.options.boxLeft +
              ...
              createStyleDefault: function() {
                  ...
                  this.options.isIE7 || this.options.isIE6 ? (a += " .html5gallery-loading-" + this.id + " {display:none; }", a += " .html5gallery-loading-center-" + this.id + " {display:none; }") : (a += " .html5gallery-loading-" + this.id + " {display:block; position:absolute; top:4px; right:4px; width:100%; height:100%; background:url('" + this.options.skinfolder + "loading.gif') no-repeat top right;}", a += " .html5gallery-loading-center-" + this.id + " {display:block; position:absolute; top:0px; left:0px; width:100%; height:100%; background:url('" +
                  ...
                  this.options.showcarousel && this.options.carouselmultirows ? (a += " .html5gallery-car-" + this.id + " { position:absolute; display:block; overflow:hidden; left:" + this.options.carouselLeft + "px; top:" + this.options.carouselTop + "px; width:" + this.options.width + "px;", a = this.options.carouselbgtransparent ? a + "background-color:transparent;" : a + ("border-top:1px solid " + this.options.carouseltopborder + ";border-bottom:1px solid " + this.options.carouselbottomborder + ";background-color: " + this.options.carouselbgcolorend + "; background: " +
                          ...
                          this.id + " { filter:alpha(opacity=100); opacity:1; } ", a += " .html5gallery-tn-img-" + this.id + " {display:block; overflow:hidden; width:" + String(this.options.thumbimagewidth + 2 * this.options.thumbimageborder) + "px;height:" + String(this.options.thumbimageheight + 2 * this.options.thumbimageborder) + "px;}", this.options.thumbunselectedimagebordercolor && (a += " .html5gallery-tn-selected-" + this.id + " {background-color:" + this.options.thumbunselectedimagebordercolor + ";}"), this.options.thumbshowtitle ? (a += " .html5gallery-tn-title-" +
                              ...
                              if (this.options.thumbShowNum >=
                                  this.elemArray.length) b(".html5gallery-car-left-" + this.id, this.$gallery).css({
                                  "background-position": "-" + String(2 * this.options.carouselarrowwidth) + "px 0px",
                                  cursor: ""
                              ...
                              if (parseInt(a.css("margin-left")) != -(this.options.thumbTotalWidth - this.options.thumbMaskWidth + this.options.thumbgap)) {
                                  var c = -1 * parseInt(a.css("margin-left")) + this.options.thumbShowNum *
              ...
              goNormal: function() {
                  ...
                  if (0 < b(".html5gallery-elem-" + this.id, this.$fullscreen).length) {
                      var a = b(".html5gallery-elem-" +
                          this.id, this.$fullscreen).empty().css({
              ...
              goFullscreen: function() {
                  ...
                  this.fullscreenHeight = e - 2 * this.fullscreenMargin - this.fullscreenBarH -
                  ...
                  this.$fullscreen = b("<div class='html5gallery-fullscreen-" + this.id +
              ...
              slideRun: function(a, c, d, e) {
                  ...
                  if (!(0 > a)) {
                      ...
                      (this.elemArray[this.curElem][5] || (this.options.lightbox || this.elemArray[this.curElem][22]) && !this.isFullscreen) && (!this.options.linkonlyonvideo || !(5 == a || 6 == a || 7 == a || 8 == a)) ? (c.css({
                          ...
                          (g.options.lightbox ||
                              g.elemArray[g.curElem][22]) && !g.isFullscreen ? g.goFullscreen() : g.elemArray[g.curElem][5] && (g.elemArray[g.curElem][6] ? window.open(g.elemArray[g.curElem][5], g.elemArray[g.curElem][6]) : window.open(g.elemArray[g.curElem][5]))
                      })) : (c.css({
                          cursor: ""
                      }), c.unbind("click"))
                  }
              ...
              showImage: function() {
                  ...
                  $preloading = "" === a.html() ? b("<div class='html5gallery-loading-center-" + this.id + "'></div>").appendTo(a) : b("<div class='html5gallery-loading-" +
                      this.id + "'></div>").appendTo(a);
                  var c = this,
                      d = new Image;
                  b(d).load(function() {
                      $preloading.remove();
                      ...
                      if (c.isFullscreen) {
                          ...
                          d = 1 < d ? 1 : d
                      } else d = "fill" == c.options.resizemode ? Math.max(c.options.width /
                          this.width, c.options.height / this.height) : Math.min(c.options.width / this.width, c.options.height / this.height);
                      e = Math.round(d * this.width);
                      d = Math.round(d * this.height);
                      ...
                      e = b("<div class='html5gallery-elem-img-" + c.id + "' style='display:block; position:absolute; overflow:hidden; width:" + h + "px; height:" + l + "px; left:0px; margin-left:" +
                      ...
                      d.length ? (a.prepend(e), a.html5boxTransition(c.id,
                          d, e, {
              ...
              adjustFullscreen: function(a, c, d) {
                  ...
                  var f = window.innerHeight ? window.innerHeight :
                      b(window).height();
                  ...
                  var h = Math.max(f, b(document).height()),
                      ...
                      l = Math.min(l / a, g / c);
                  1 > l && (a *= l, c *= l);
                  f = b(window).scrollTop() + Math.round((f - (c + 2 * this.fullscreenMargin +
                  ...
                  b(".html5gallery-fullscreen-play-" + this.id, this.$fullscreen).css("display", this.isPaused && 1 < this.elemArray.length && 1 == this.elemArray[this.curElem][9] ? "block" :
                      "none");
                  ...
                  b(".html5gallery-elem-video-" +
                      this.id, this.$fullscreen).find("iframe").attr("height", c);
                  b("#html5gallery-elem-video-" + this.id, this.$fullscreen).find("iframe").attr("width", a);
              ...
              showPoster: function() {
                  ...
                  b(h).load(function() {
                      ...
                      var h, g, k;
                      d.isFullscreen ? (g = d.elemArray[d.curElem][17] ? Math.min(d.elemArray[d.curElem][17], d.fullscreenWidth) : Math.min(e, d.fullscreenWidth), k = d.elemArray[d.curElem][18] ? Math.min(d.elemArray[d.curElem][18], d.fullscreenHeight) : Math.min(f, d.fullscreenHeight), h = Math.max(g / this.width, k / this.height),
                          h = 1 < h ? 1 : h) : (h = "fill" == d.options.resizemode ? Math.max(d.options.width / this.width, d.options.height / this.height) : Math.min(d.options.width / this.width, d.options.height / this.height), g = d.options.width, k = d.options.height);
                      var p = Math.round(h * this.width);
                      h = Math.round(h * this.height);
                      var q = Math.round(g / 2 - p / 2),
                          m = Math.round(k / 2 - h / 2);
                      d.isFullscreen && d.adjustFullscreen(g, k);
                      c.css({
                          width: g,
                          height: k
                      });
                      g = b("<div class='html5gallery-elem-img-" + d.id + "' style='display:block; position:absolute; overflow:hidden; width:" +
                          g + "px; height:" + k + "px; left:0px; margin-left:" + (d.options.slideshadow && !d.isFullscreen ? 4 : 0) + "px; top:0px; margin-top:" + (d.options.slideshadow && !d.isFullscreen ? 4 : 0) + "px;'><img class='html5gallery-elem-image-" + d.id + "' style='border:none; position:absolute; opacity:inherit; filter:inherit; padding:0px; margin:0px; left:" + q + "px; top:" + m + "px; max-width:none; max-height:none; width:" + p + "px; height:" + h + "px;' src='" + d.elemArray[d.curElem][12] + "' />" + d.options.watermarkcode + "</div>");
                      k = b(".html5gallery-elem-img-" +
                          d.id, c);
                      ...
                      b(".html5gallery-video-play-" + d.id, a).length || b("<div class='html5gallery-video-play-" + d.id + "' style='position:absolute;display:block;cursor:pointer;top:50%;left:50%;width:64px;height:64px;margin-left:-32px;margin-top:-32px;background:url(\"" + d.options.skinfolder + "playvideo_64.png\") no-repeat center center;'></div>").appendTo(c).unbind(d.eClick).bind(d.eClick,
                          function() {
                  ...
                  b(h).error(function() {
                      $preloading.remove();
                      d.isFullscreen &&
                          d.adjustFullscreen(d.options.width, d.options.height);
              ...
              playVideo: function() {
                  ...
                  if (5 == a || 6 == a || 7 == a || 8 == a) this.isHTML5 && 0 < b("#html5gallery-elem-html5-video-" + this.id).length ? b("#html5gallery-elem-html5-video-" + this.id, this.container).get(0).play() : (a = this.getFlashMovieObject("html5gallery-elem-video-flash-" +
              ...
              showVideo: function(a, c) {
                  ...
                  if (this.isHTML5) {
                      ...
                      if (this.options.isFirefox || this.options.isOpera || !l) l = this.elemArray[this.curElem][4] ? this.elemArray[this.curElem][4] : this.elemArray[this.curElem][3], g = this.elemArray[this.curElem][15] ? this.elemArray[this.curElem][15] : this.elemArray[this.curElem][14];
              ...
              showIframe: function() {
                  ...
                  if (this.isFullscreen) {
                      var c =
                          this.elemArray[this.curElem][17] ? Math.min(this.elemArray[this.curElem][17], this.fullscreenWidth) : Math.min(c, this.fullscreenWidth),
                  ...
                  b(".html5gallery-elem-iframe-" + this.id, a).html("<iframe id='html5gallery-iframe-" + this.id + "' width='" + d + "' height='" + c + "' src='" + e +
              ...
              checkType: function(a) {
                  return !a ? -1 : a.match(/\.(jpg|gif|png|bmp|jpeg)(.*)?$/i) ? 1 : a.match(/[^\.]\.(swf)\s*$/i) ? 2 : a.match(/[^\.]\.(mp3)\s*$/i) ? 3 : a.match(/[^\.]\.(pdf)\s*$/i) ? 4 : a.match(/\.(flv)(.*)?$/i) ? 5 : a.match(/\.(mp4|m4v)(.*)?$/i) ? 6 : a.match(/\.(ogv|ogg)(.*)?$/i) ? 7 : a.match(/\.(webm)(.*)?$/i) ?
                      8 : a.match(/\:\/\/.*(youtube\.com)/i) || a.match(/\:\/\/.*(youtu\.be)/i) ? 9 : a.match(/\:\/\/.*(vimeo\.com)/i) ? 10 : a.match(/\:\/\/.*(dailymotion\.com)/i) || a.match(/\:\/\/.*(dai\.ly)/i) ? 11 : 1
              },
              onChange: function() {
              ...
              embedHTML5Video: function(a,
                  ...
                  !this.options.nativehtml5controls && !this.options.videohidecontrols &&
                      (b("video", a).data("src", e), b("video", a).data("hd", f), b("video", a).data("ishd", this.isHd), b("video", a).addHTML5VideoControls(this.options.skinfolder, this, "html5gallery-elem-html5-video-" + this.id));
                  this.elemArray[this.curElem][5] && (b("video", a).css({
                      cursor: "pointer"
                  }), b("video", a).unbind("click").bind("click", function() {
              ...
              embedFlash: function(a, b, d, e, f, h, k) {
                  if (this.options.flashInstalled) {
                      ...
                      window.HTML5GallerySWFObject.embedSWF(e,
                          k, b, d, "9.0.0", !1, h, g, {})
          ...
          this.each(function() {
              ...
              if ((!b(this).data("donotinit") || k && k.forceinit) && !b(this).data("inited")) {
                  ...
                  c = {
                      ...
                      titleoverlay: !0,
                      titleautohide: !0,
                      titlecss: " {color:#ffffff; font-size:18px; font-family:Arial,Helvetica,sans-serif; overflow:hidden; text-align:left; padding:10px 0px 10px 10px; background-color: rgba(0, 0, 0, 0.5); background: rgba(0, 0, 0, 0.5); }",
                      titlecsslink: " a {color:#ffffff;}",
                      descriptioncss: " {color:#ffffff; font-size:13px; font-family:Arial,Helvetica,sans-serif; overflow:hidden; text-align:left; padding:0px 0px 10px 10px; background-color: rgba(0, 0, 0, 0.5); background: rgba(0, 0, 0, 0.5); }",
                  ...
                  var j = {
                          ...
                          titleoverlay: !0,
                          titleautohide: !0,
                          titlecss: " {color:#ffffff; font-size:18px; font-family:Arial,Helvetica,sans-serif; overflow:hidden; white-space:normal; text-align:left; padding:10px 0px 10px 10px;  background-color: rgba(0, 0, 0, 0.5); background: rgba(0, 0, 0, 0.5); }",
                          titlecsslink: " a {color:#ffffff;}",
                      ...
                      m = "vertical" == this.options.skin ? b.extend(m, q) : "showcase" == this.options.skin ? b.extend(m, p) : "light" == this.options.skin ? b.extend(m, j) : "gallery" == this.options.skin ? b.extend(m, h) : "gallerywithtext" == this.options.skin ? b.extend(m, l) : "horizontal" == this.options.skin ? b.extend(m, c) : "darkness" == this.options.skin ? b.extend(m, g) : "mediapage" == this.options.skin ? b.extend(m, f) : b.extend(m, c);
                  this.options = b.extend(m,
                      this.options);
                  ...
                  "/" != this.options.skinfolder.charAt(0) && ("http:" != this.options.skinfolder.substring(0, 5) && "https:" !=
                      this.options.skinfolder.substring(0, 6)) && (this.options.skinfolder = this.options.jsfolder + this.options.skinfolder);
                  ...
                  if (this.options.screenquery)
                      for (c in this.options.screenquery) j <= this.options.screenquery[c].screenwidth && (this.options.screenquery[c].gallerywidth && (this.options.width = this.options.screenquery[c].gallerywidth), this.options.screenquery[c].galleryheight && (this.options.height = this.options.screenquery[c].galleryheight), this.options.screenquery[c].thumbwidth &&
                          (this.options.thumbwidth = this.options.screenquery[c].thumbwidth), this.options.screenquery[c].thumbheight && (this.options.thumbheight = this.options.screenquery[c].thumbheight));
  ...
  function HTML5GallerySWFObjectFunc() {
              ...
              for (var c = 0; c < b; c++) {
                  ...
                  if (0 < r.pv[0]) {
                      ...
                      if (l)
                          ...
                          for (var m = {}, l = l.getElementsByTagName("param"), n = l.length, p = 0; p < n; p++) "movie" != l[p].getAttribute("name").toLowerCase() && (m[l[p].getAttribute("name")] = l[p].getAttribute("value"));
                          B(j, m, g, h)
                      } else k(l), h && h(j)
                  } else if (d(g, !0), h) {
      ...
      function B(a, c, d, h) {
          ...
          var j = e(d);
          if (j) {
              "OBJECT" == j.nodeName ? (P = b(j), J = null) : (P = j, J = d);
              a.id = g;
              ...
              r.ie && (r.win && 4 != j.readyState) && (h = p.createElement("div"), d += "SWFObjectNew", h.setAttribute("id", d), j.parentNode.insertBefore(h, j), j.style.display = "none", function() {
      ...
      function G(a, b, c) {
          ...
          if (g)
              if (typeof a.id == f && (a.id = c), r.ie && r.win) {
                  ...
                  for (j in b) b[j] != Object.prototype[j] && "movie" != j.toLowerCase() && (a = m, k = j, q = b[j], c = p.createElement("param"), c.setAttribute("name", k), c.setAttribute("value", q), a.appendChild(c));
      ...
      if (typeof H.plugins != f && typeof H.plugins["Shockwave Flash"] ==
          h) {
          if ((y = H.plugins["Shockwave Flash"].description) && !(typeof H.mimeTypes != f && H.mimeTypes[l] && !H.mimeTypes[l].enabledPlugin)) V = !0, L = !1, y = y.replace(/^.*\s+(\S+\s+\S+$)/, "$1"), F[0] = parseInt(y.replace(/^(.*)\..*$/, "$1"), 10), F[1] = parseInt(y.replace(/^.*\.(.*)\s.*$/, "$1"), 10), F[2] = /[a-zA-Z]/.test(y) ? parseInt(y.replace(/^.*[a-zA-Z]+(.*)$/, "$1"), 10) : 0
